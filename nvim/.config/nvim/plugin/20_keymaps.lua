...
nmap_leader('v', '<Cmd>vsplit<CR>', 'Vertical Split')
...
nmap_leader('gb', '<Cmd>:vertical Git blame -- %<CR>',         'Added diff')
...
nmap_leader('F', notifyFormat(), 'Format')
xmap_leader('F', notifyFormat(), 'Format')
