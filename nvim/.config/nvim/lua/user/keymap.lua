...
-- neotest
vim.keymap.set("n", "<leader>tf", "<cmd>lua require('neotest').run.run()<cr>")
...
vim.keymap.set("n", "<leader>fd",
               "<cmd>lua require('user.telescope').search_documents()<cr>")
vim.keymap.set("n", "<leader>ff", "<cmd>Telescope find_files<cr>")
vim.keymap.set("n", "<leader>fG",
               "<cmd>lua require('user.telescope').search_go_files()<cr>")
vim.keymap.set("n", "<leader>fg",
...
vim.keymap.set("n", "<leader>V",
               "<c-w>v<c-w>l | <cmd>Telescope telescope-alternate alternate_file<cr>")

-- vim-test
-- vim.keymap.set("n", "<leader>tn", "<cmd>TestNearest<cr>")
-- vim.keymap.set("n", "<leader>tt", "<cmd>TestFile<cr>")
-- vim.keymap.set("n", "<leader>tp", "<cmd>TestVisit<cr>")
